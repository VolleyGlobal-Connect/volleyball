...
export function ProfileCard({ profile }: ProfileCardProps) {
  ...
  return (
    <Card className="group relative flex flex-col overflow-hidden bg-white border-2 border-gray-200 hover:border-orange-500 transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
      ...
      <div className="relative h-60 overflow-hidden">
        ...
        <div className="absolute bottom-3 left-3">
          <Badge className="bg-orange-500 text-white border-0 text-xs font-bold uppercase tracking-wide">
      ...
      <div className="p-6 space-y-4 flex flex-col flex-1">
        ...
        <div className="space-y-2">
          <h3 className="text-xl font-bold text-gray-900 group-hover:text-orange-600 transition-colors h-14">
            {profile.name}
          </h3>
        </div>
        ...
        <div className="pt-4 border-t border-gray-100">
          <Link href={`/users/${profile.slug}`} passHref>
            <Button className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold uppercase tracking-wide">
              Learn More
